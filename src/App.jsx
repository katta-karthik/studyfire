...
function App() {
  const [currentView, setCurrentView] = useState('dashboard'); // 'dashboard', 'challenges', 'create', 'timer'
  const [selectedChallenge, setSelectedChallenge] = useState(null);
  const { challenges, addChallenge, updateChallenge, deleteChallenge, reloadChallenges } = useChallenges(true);
  const { activeTimer, formattedTime } = useTimer();

  // Reload challenges when switching to dashboard or from time tracker
  useEffect(() => {
